import type { PharmacyDataItem, WardDataItem } from "./types";

export const getPharmacyData = (medical: any): PharmacyDataItem[] => [
  {
...
export const getWardsData = (medical: any): WardDataItem[] => [
  {
