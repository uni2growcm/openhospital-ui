  ...
  const onSubmit = (mh: MedicalHistoryDTO) => {
    ...
    if (creationMode) {
      ...
      let medicalHistoryToSave: MedicalHistoryDTO = {
        ...
        combinedBreastfeeding: mh.combinedBreastfeeding,
        ...
        noApplicableDeparasitation: mh.noApplicableDeparasitation,
