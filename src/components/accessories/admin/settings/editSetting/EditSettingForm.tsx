...
import { type SettingDTO, SettingDTOTypeEnum } from '~/generated';
...
const EditSettingForm: FC<IOwnProps> = ({ setting, onSucceed, onCancel }) => {
	...
	const validationSchema = object().shape({
		value: string()
			...
			.test('valid-option', t('form.invalidField'), (value) => {
				if (setting.type === SettingDTOTypeEnum.Select) {
					const options = (setting.valueOptions ?? '').split(',');
