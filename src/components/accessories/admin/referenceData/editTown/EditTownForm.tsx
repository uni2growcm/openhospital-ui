...
export const EditTownForm = ({
  ...
  const formik = useFormik<TownDTO>({
    initialValues,
    validationSchema,
  ...
  return (
    <div className="town-form-container">
      {hasFailed && (
        <InfoBox
          type="error"
       ...
       <div className="editTownForm__actions">
          <DiscardButton />
        </div>

      <form onSubmit={formik.handleSubmit}>
        <div className="editTownForm__item textfield fullwidth">   
          <TextField
