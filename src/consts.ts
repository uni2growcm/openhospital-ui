...
export const PATHS = {
  ...
  admin_communes: "/admin/reference-data/communes",
  admin_communes_new: "/admin/reference-data/communes/new",
  admin_communes_edit: "/admin/reference-data/communes/:id/edit",
