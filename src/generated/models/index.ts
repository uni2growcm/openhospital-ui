...
export * from './LabbookAnalysisDTO';
export * from './LabbookAnalysisVariableDTO';
export * from './LabbookPatientHistoricDTO';
export * from './LabbookRawPatientDTO';
...
export * from './ReportGroupedRequest';
export * from './Series';
