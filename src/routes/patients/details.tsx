...
export const PATIENT_DETAILS_ROUTES = [
  ...
  },
  {
    path: "discharge",
    lazy: async () =>
      import("../../components/activities/patientDetailsActivityContent/DischargeDetailsActivityContent").then(
        (module) => ({
  ...
  },
  {
    path: "operation",
    lazy: async () =>
      import("../../components/accessories/patientOperation/PatientOperation").then(
        (module) => ({ Component: module.PatientOperation }),
      ),
  },
  {
    path: "*",
